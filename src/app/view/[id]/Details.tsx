...
export default function VehicleDetails({
  ...
  return (
    <div className="bg-white">
      <main className="-mt-16 mx-auto px-4 pb-24 pt-14 sm:px-6 sm:pb-32 sm:pt-16 lg:max-w-7xl lg:px-8">
        <div className="lg:grid lg:grid-cols-7 lg:grid-rows-1 lg:gap-x-8 lg:gap-y-10 xl:gap-x-16">
          <div className="lg:col-span-4 lg:row-end-1">
            <div className="relative aspect-h-3 aspect-w-4 overflow-hidden rounded-lg bg-gray-200">
          ...
          <div className="mx-auto mt-14 max-w-2xl sm:mt-16 lg:col-span-3 lg:row-span-2 lg:row-end-2 lg:mt-0 lg:max-w-none">
            ...
            <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-1">
              <Link
                ...
                Book Now - £ {vehicle.pricePerDay.toFixed(2)} per day
              </Link>
            </div>
            ...
            <div className="mt-10 border-t border-gray-200 pt-10">
              ...
              <div className="mt-4 text-sm text-gray-500 text-center">
                <div className="inline-block">
                  <AvilabilityCalendar availabilityDates={availabilities} />
                </div>
              </div>
            ...
            <Tab.Group as="div">
              ...
              <Tab.Panels as={Fragment}>
                <Tab.Panel className="-mb-10">
                  ...
                  {reviews.featured.length < 1 && <h4 className="py-6">No reviews yet.</h4>}
...
const faqs = [
  {
    question: "How do I book this car?",
    answer: `To book this car, click on the "Book Now" button on the vehicle details page. Follow the prompts to select your desired dates and provide any required information. Once confirmed, you'll receive instructions on the next steps.`,
  },
  {
    question: "Is insurance included in the rental cost?",
    answer:
      "Yes, basic insurance coverage is included in the rental cost. Additional insurance options may be available during the booking process.",
  },
  {
    question: "What documents do I need to rent this car?",
    answer: `Typically, you'll need a valid driver's license and a form of identification. Specific requirements may vary, so check the "Rental Requirements" section on the vehicle page for any additional documents needed.`,
  },
  {
    question: "Are pets allowed in the car?",
    answer: `The pet policy depends on the individual car owner. You can message the owner directly.`,
  },
  {
    question: "How does the pick-up and drop-off process work?",
    answer: `The pick-up and drop-off details will be provided upon confirmation of your booking. It's important to communicate with the car owner through our messaging system to coordinate a convenient meeting point and time.`,
  },
  {
    question: "What happens if the car breaks down during my rental?",
    answer: `In case of a breakdown, contact the car owner immediately. Most listings include roadside assistance information. If needed, you can also reach out to our support team for assistance.`,
  },
];
...
type AvilabilityCalendarProps = {
  availabilityDates: Omit<VehicleAvailability, "id" | "vehicleId">[];
};
function AvilabilityCalendar({ availabilityDates }: AvilabilityCalendarProps) {
